...
UC9:
alter table addresstable add type(varchar 255);
...
insert into type(id, relation, book_key) values (5, 'family', 5);
select * from addressbook join type on type.book_key = addressbook.id;
